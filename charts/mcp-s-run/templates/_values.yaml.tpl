...
*/ -}}
{{- define "hlmfk-1-2-b722b437a3.valuesYaml" -}}
{{- $runtime_secret_name := include "hlmfk-1-2.getValue" (dict "Values" .Values "path" (list "secretName") "default" "mcp-s-run-container-secret-vars") -}}
