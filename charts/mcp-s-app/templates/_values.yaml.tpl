...
*/ -}}
{{- define "hlmfk-1-2-27aa2d6e61.valuesYaml" -}}
{{- $runtime_secret_name := include "hlmfk-1-2.getValue" (dict "Values" .Values "path" (list "secretName") "default" "mcp-s-app-container-secret-vars") -}}
