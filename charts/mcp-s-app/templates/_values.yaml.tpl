...
*/ -}}
{{- define "hlmfk-1-2-ad161e17c0.valuesYaml" -}}
...
{{- $anchor_registry_default := printf `quay.io/webrix/mcp-s-app` -}}
...
{{- $anchor_deployment_name_default := printf `mcp-s-app` -}}
{{- $final_namespace := "" -}}
...
globals:
  ...
  images:
    - image: quay.io/webrix/mcp-s-app
