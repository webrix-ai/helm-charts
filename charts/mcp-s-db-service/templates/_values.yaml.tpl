{{- /*
This file was autogenerated by helmify-kustomize v1.2.18
DO NOT EDIT: Any changes will be overwritten
*/ -}}
{{- define "hlmfk-1-2-f6c2322f6c.valuesYaml" -}}
{{- $runtime_secret_name := include "hlmfk-1-2.getValue" (dict "Values" .Values "path" (list "secretName") "default" "mcp-s-db-service-container-secret-vars") -}}
...
{{- $final_secret_name := include "hlmfk-1-2.pickFirstNonEmpty" (list $runtime_secret_name $anchor_secret_name_default) -}}
...
env:
  ...
  ORG: on-prem-org
  DEBUG_QUERIES: "true"
` $final_namespace $final_replicas $final_app_tag $final_secret_name -}}
{{- $result -}}
{{- end -}}