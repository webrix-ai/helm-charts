...
{{- define "hlmfk-0-0.valuesYaml" -}}
{{- $runtime_app_tag := include "hlmfk-0-0.getValue" (dict "Values" .Values "path" (list "applicationVersion") "default" "latest") -}}
