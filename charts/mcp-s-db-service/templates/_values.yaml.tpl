...
*/ -}}
{{- define "hlmfk-1-2-17d2ebff37.valuesYaml" -}}
...
{{- $anchor_registry_default := printf `quay.io/webrix/mcp-s-db-service` -}}
...
{{- $anchor_deployment_name_default := printf `mcp-s-db-service` -}}
{{- $final_namespace := "" -}}
...
globals:
  ...
  images:
    - image: quay.io/webrix/mcp-s-db-service
