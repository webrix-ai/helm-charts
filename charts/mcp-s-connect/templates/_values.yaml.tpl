...
*/ -}}
{{- define "hlmfk-1-2-6c39403505.valuesYaml" -}}
...
{{- $anchor_registry_default := printf `quay.io/webrix/mcp-s-connect` -}}
...
{{- $anchor_deployment_name_default := printf `mcp-s-connect` -}}
{{- $final_namespace := "" -}}
...
globals:
  ...
  images:
    - image: quay.io/webrix/mcp-s-connect
